...
<Warning>
SDK `{{release-version}}` requires the matching Mentra Live `{{release-version}}` glasses software. [Update Mentra Live before testing SDK features](/bluetooth-sdk/software-update).
</Warning>
