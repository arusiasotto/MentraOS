...
await writeFile(`${distDir}/ui/index.html`, uiHtml.replaceAll("__WATCH_GESTURES_VERSION__", miniappManifest.version))
await copyFile("./miniapp.json", `${distDir}/miniapp.json`)
await copyFile("./icon.png", `${distDir}/icon.png`)

console.log("built watch-gestures -> dist/background/index.js + dist/ui + dist/icon.png + dist/miniapp.json")
