const en = {
  deviceSettings: {
    ...
    disconnectController: "Disconnect controller",
    forgetGlasses: "Unpair glasses",
    forgetController: "Unpair controller",
    general: "General",
    charging: "Charging",
    selectDefaultApp: "Select default app",
    pairController: "Pair controller",
  },
  deviceInfo: {
    title: "Device Info",
  ...
  pairingGuides: {
    ...
    KEYFOB: {
      disclaimer:
        "Unofficial community project. Not affiliated with, endorsed by, or a product of Seeed Studio.",
      step1: "Flash the Keyfob firmware, power the XIAO nRF52840 Plus from USB or battery, and wait for the blue LED blink.",
      step2: "The fob advertises as Keyfob-XXXX. Stay close to your phone while Mentra scans, then use D0/D1/D2 like the R1 ring.",
    },
  },
  connectivity: {
  ...
  onboarding: {
    ...
    keyfobConnected: "XIAO Keyfob connected",
  ...
  home: {
    ...
    connectRing: "Connect controller",
    ...
    connectingController: "Connecting controller...",
  ...
  settings: {
    ...
    disconnectControllerTitle: "Disconnect the controller?",
    disconnectControllerConfirm: "Are you sure you want to disconnect the controller?",
    forgetController: "Unpair controller",
    forgetControllerConfirm:
      "To finish the process, make sure to remove your controller from your phone's Bluetooth settings.",
    signOut: "Sign Out",
